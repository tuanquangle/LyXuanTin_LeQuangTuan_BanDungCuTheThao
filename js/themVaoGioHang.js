...
function addcart(productImg, productName, productPrice) {
    ...
    var divContent = '<div><div class="body-cart-products"><div class="body-text info-product-cart" style="display: flex; align-items: center;"><img src="'+productImg+'" alt="" style="width: 110px;">'+productName+'</div><div class="body-text info-price-cart"><p><span>'+productPrice+'</span>đ</p></div><div class="body-text info-number-cart"><input style="width: 30px; outline: none;" type="number" value="1" min="1"></div><div class="body-text info-total-cart"><p><span>'+productPrice+'</span>đ</p></div><div class="body-text info-del-cart"><button class="body-text del-item-cart del">Xoa</button></div></div></div>'
